...
Server.default.waitForBoot({
    ...
    var quickCall = {
        ...
        newSequence = Pbind.new(
            ...
            \duration, Pseq.new([0.2], repeats: 4),
            \dur, Pseq.new([0.25], repeats: 4) 
        );
    ...
    symbols.size.do({
        ...
        if(index < telephoneArray.size){
            button.action_({
                Synth.new(\sine, [\freq, telephoneArray[index][0]]); 
                Synth.new(\sine, [\freq, telephoneArray[index][1]]); 
